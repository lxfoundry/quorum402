...
| **the expired seat** | the payer redeeming is refused **409** — and told the contract and method to reclaim at, which is the whole of what a coordinator owes a pool it could not fill |
